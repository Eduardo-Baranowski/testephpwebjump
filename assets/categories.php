    ...
    <table class="data-grid">
      ...
      <tr class="data-row">
        <td class="data-grid-td">
            <span class="data-grid-cell-content"><?= $categoria['category_name']; ?> <Br /></span>
        </td>
      
        <td class="data-grid-td">
            <span class="data-grid-cell-content"><?= $categoria['category_code']; ?> <Br /></span>
        </td>
      
        <td class="data-grid-td">
          <div class="actions">
                <div class="action edit"><span>Edit</span></div>
              <form action="services/remove_categoria.php" method="post">
