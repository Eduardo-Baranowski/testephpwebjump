...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form action="services/ad_product.php" method="post" enctype="multipart/form-data">
      <div class="input-field">
        <label for="sku" class="label">Product SKU</label>
        <input type="text" id="sku" name="sku" class="input-text" />
      </div>
      <div class="input-field">
        <label for="nome" class="label">Product Name</label>
        <input type="text" id="nome" name="nome" class="input-text" />
      </div>
      <div class="input-field">
        <label for="preco" class="label">Price</label>
        <input type="text" id="preco" name="preco" class="input-text" />
      </div>
      <div class="input-field">
        <label for="quantidade" class="label">Quantity</label>
        <input type="text" id="quantidade" name="quantidade" class="input-text" />
      </div>

        <div class="input-field">

            <label for="cate_lista" class="label">Categories</label>
            <select id="cate_lista" name="cate_lista[]"  multiple class="input-text">
                <?php
                ...
                <?php foreach($categorias as $categoria): ?>
                    <option value="<?=$categoria['category_id']?>"><?= $categoria['category_id']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>

      <div class="input-field">
        <label for="descricao" class="label">Description</label>
        <textarea id="descricao" name="descricao" class="input-text"></textarea>
      </div>
        <div class="input-field">
