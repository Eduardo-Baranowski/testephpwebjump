    ...
    <table class="data-grid">
      ...
      <tr class="data-row">
        ...
        <td class="data-grid-td">
            ...
            $categorias = listaCategoriasProduto($conexao, $produto['id']);
            ?>
            <?php foreach($categorias as $categoria): ?>
                <span class="data-grid-cell-content"><?= $categoria['pk_categoria']; ?> <Br /></span>
            <?php endforeach; ?>
        </td>
        ...
        <td class="data-grid-td">
          <div class="actions">
            <div class="action edit"><span>Edit</span></div>
              <form action="services/remove_produto.php" method="post">
